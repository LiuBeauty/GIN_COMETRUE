...
def main():
    ...
    parser.add_argument('--dataset', type=str, default="TESTLIU3",
    ...
    # print("feature shape:" + str(train_graphs[0].node_features.shape[1]))
    model = GraphCNN(args.num_layers, args.num_mlp_layers, 2, args.hidden_dim,
    ...
    x_axis_data = [i for i in range(1,200)]
