...
def load_data(dataset, degree_as_tag):
    ...
    with open('dataset/%s/%s.txt' % (dataset, dataset), 'r') as f:
        ...
        for i in range(n_g): #对于每张图
            ...
            g_list.append(S2VGraph(g, l,graph_feature ))

    #add labels and edge_mat
    # print('node_feature:##############################################################3',str(node_features))
    ...
    # if degree_as_tag:
    #     for g in g_list:
    #         g.node_tags = list(dict(g.nxg.degree).values())
    ...
    # print(len(tagset))
    # tagset = list(tagset)
#     print('here:'+str(tagset))

    # tag2index = {tagset[i]:i for i in range(len(tagset))}
#     print('here 130 tag2index:'+str(tag2index))
#     i = 0
#     for g in g_list:
#         i += 1
#         c= torch.zeros(len(g.node_tags), len(tagset))
#         g.node_features[range(len(g.node_tags)),0] = 0.2
#         g.node_features[range(len(g.node_tags)),1] = 0.3
